...
const Users = React.lazy(() => import('./views/setups/Users'))
const Roles = React.lazy(() => import('./views/setups/Roles'))
const Permissions = React.lazy(() => import('./views/setups/Permissions'))
const Menu = React.lazy(() => import('./views/setups/Menu'))
...
export const routes = [
  ...
  { path: '/setups/menu', name: 'Menu', element: Menu },
  { path: '/setups/permissions', name: 'Permissions', element: Permissions },
  { path: '/setups/roles', name: 'Roles', element: Roles },
